...
- [Architecture](../ARCHITECTURE.md): evidence-backed system structure and open questions.
- [Domain terminology](domain/terminology.md): provisional terms in the project brief.
...
- [Agent skill configuration](agents/skills.md) and [issue tracker](agents/issue-tracker.md).

The root [README](../README.md) is a short landing page. The original [project brief](project-brief.md)
contains exploratory examples; they do not override future normative docs or conformance tests.
